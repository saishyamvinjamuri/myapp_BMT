        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading"><h3>Chair will be waiting to see you at updated time</h3></div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td><a href = {{ route('book.create') }} class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus"></span></a>&nbsp;
                                    ...
                                    <a href = {{ route('book.edit', $slot->id) }} class="btn btn-danger btn-sm"> <span class="glyphicon glyphicon-trash"></span> </a> </span> </td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
